...
{
    return IM_NEW(ImGuiTableSortSpecsColumn)();
}
...
{
    return ImGui::TableBeginUpdateColumns(table);
}
CIMGUI_API void igTableUpdateDrawChannels(ImGuiTable* table)
{
    return ImGui::TableUpdateDrawChannels(table);
}
...
{
    return ImGui::TableSetColumnVisible(column_n,visible);
}
...
{
    return ImGui::TableReorderDrawChannelsForMerge(table);
}
...
CIMGUI_API void igPushTableBackground()
{
    return ImGui::PushTableBackground();
}
CIMGUI_API void igPopTableBackground()
{
    return ImGui::PopTableBackground();
}
...
{
    return ImGui::TableSettingsClearByID(id);
}
