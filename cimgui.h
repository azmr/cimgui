...
typedef struct ImGuiTableSortSpecsColumn ImGuiTableSortSpecsColumn;
...
typedef struct ImSpan_ImS8 {ImS8* Data;ImS8* DataEnd;} ImSpan_ImS8;
...
typedef struct ImVector_ImGuiTableSortSpecsColumn {int Size;int Capacity;ImGuiTableSortSpecsColumn* Data;} ImVector_ImGuiTableSortSpecsColumn;
...
typedef enum {
    ...
    ImGuiTableFlags_SizingPolicyFixedX = 1 << 14,
    ImGuiTableFlags_SizingPolicyStretchX = 1 << 15,
    ImGuiTableFlags_NoHeadersWidth = 1 << 16,
    ImGuiTableFlags_NoHostExtendY = 1 << 17,
    ImGuiTableFlags_NoKeepColumnsVisible = 1 << 18,
    ImGuiTableFlags_PreciseStretchWidths = 1 << 19,
...
typedef enum {
    ...
    ImGuiTableColumnFlags_WidthFixed = 1 << 2,
    ImGuiTableColumnFlags_WidthStretch = 1 << 3,
    ImGuiTableColumnFlags_WidthAlwaysAutoResize = 1 << 4,
    ImGuiTableColumnFlags_NoResize = 1 << 5,
    ImGuiTableColumnFlags_NoClipX = 1 << 6,
    ImGuiTableColumnFlags_NoSort = 1 << 7,
    ImGuiTableColumnFlags_NoSortAscending = 1 << 8,
    ImGuiTableColumnFlags_NoSortDescending = 1 << 9,
    ImGuiTableColumnFlags_NoHide = 1 << 10,
    ...
    ImGuiTableColumnFlags_NoReorder = 1 << 16,
    ...
    ImGuiTableColumnFlags_NoDirectResize_ = 1 << 20
...
struct ImGuiTableSortSpecs
{
    const ImGuiTableSortSpecsColumn* Specs;
    int SpecsCount;
    bool SpecsDirty;
    ImU64 ColumnsMask;
};
...
struct ImGuiTableColumn
{
    ...
    ImS8 PrevVisibleColumn;
    ImS8 NextVisibleColumn;
    ImS8 SortOrder;
    ImS8 SortDirection;
    ImU8 AutoFitQueue;
    ImU8 CannotSkipItemsQueue;
    ImU8 DrawChannelCurrent;
...
struct ImGuiTable
{
    ...
    ImSpan_ImS8 DisplayOrderToIndex;
    ImSpan_ImGuiTableCellData RowCellData;
    ImU64 VisibleMaskByIndex;
    ImU64 VisibleMaskByDisplayOrder;
    ImU64 VisibleUnclippedMaskByIndex;
    ...
    ImVector_ImGuiTableSortSpecsColumn SortSpecsData;
    ImGuiTableSortSpecs SortSpecs;
    ImS8 SortSpecsCount;
    ImS8 ColumnsVisibleCount;
    ImS8 ColumnsVisibleFixedCount;
    ImS8 DeclColumnsCount;
    ImS8 HoveredColumnBody;
    ImS8 HoveredColumnBorder;
    ImS8 AutoFitSingleStretchColumn;
    ImS8 ResizedColumn;
    ImS8 LastResizedColumn;
    ImS8 HeldHeaderColumn;
    ImS8 ReorderColumn;
    ImS8 ReorderColumnDir;
    ...
    ImS8 FreezeColumnsCount;
    ImS8 RowCellDataCurrent;
    ImU8 DummyDrawChannel;
    ImU8 Bg1DrawChannelCurrent;
...
typedef ImSpan<ImS8> ImSpan_ImS8;
...
typedef ImVector<ImGuiTableSortSpecsColumn> ImVector_ImGuiTableSortSpecsColumn;
...
CIMGUI_API bool igTableGetColumnIsVisible(int column_n);
CIMGUI_API bool igTableGetColumnIsSorted(int column_n);
...
CIMGUI_API ImGuiTableSortSpecsColumn* ImGuiTableSortSpecsColumn_ImGuiTableSortSpecsColumn(void);
CIMGUI_API void ImGuiTableSortSpecsColumn_destroy(ImGuiTableSortSpecsColumn* self);
...
CIMGUI_API void igTableBeginUpdateColumns(ImGuiTable* table);
CIMGUI_API void igTableUpdateDrawChannels(ImGuiTable* table);
...
CIMGUI_API void igTableSetColumnVisible(int column_n,bool visible);
...
CIMGUI_API void igTableReorderDrawChannelsForMerge(ImGuiTable* table);
...
CIMGUI_API void igPushTableBackground(void);
CIMGUI_API void igPopTableBackground(void);
...
CIMGUI_API void igTableSettingsClearByID(ImGuiID id);
...
CIMGUI_API void igDebugNodeColumns(ImGuiColumns* columns);
